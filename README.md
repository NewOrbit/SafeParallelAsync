...
> Note: You can override the degree of parallelism on each method call or uou can change the default globally by setting `Parallelizer.MaxParallelism` field to any value you want. E.g. `Parallelizer.MaxParallelism = 150`.
